...
public class MutableBitField32x32x1Impl extends BitField32x32x1Impl implements MutableBitField {
	...
	protected void set_0(BitField32x32x1Impl that) {
		this._0 = that._0;
		this._1 = that._1;
		this._2 = that._2;
		this._3 = that._3;
	...
	protected void toImmutable_0(ImmutableBitField32x32x1Impl that) {
		that._0 = this._0;
		that._1 = this._1;
		that._2 = this._2;
		that._3 = this._3;
	...
	public MutableBitField32x32x1Impl clone() {
		var result = new MutableBitField32x32x1Impl();
		result.set(this);
		return result;
	}
	...
	protected void union_0(BitField32x32x1Impl that) {
		this._0 |= that._0;
		this._1 |= that._1;
		this._2 |= that._2;
		this._3 |= that._3;
	...
	protected void intersect_0(BitField32x32x1Impl that) {
		this._0 &= that._0;
		this._1 &= that._1;
		this._2 &= that._2;
		this._3 &= that._3;
	...
	protected void exclusive_0(BitField32x32x1Impl that) {
		this._0 ^= that._0;
		this._1 ^= that._1;
		this._2 ^= that._2;
		this._3 ^= that._3;
	...
	protected void subtract_0(BitField32x32x1Impl that) {
		this._0 &= ~that._0;
		this._1 &= ~that._1;
		this._2 &= ~that._2;
		this._3 &= ~that._3;
