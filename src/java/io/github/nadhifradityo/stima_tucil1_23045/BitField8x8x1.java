...
public class BitField8x8x1 extends BitField {
	...
	protected void set_0(BitField8x8x1 that) {
		this._0 = that._0;
	}
	...
	protected boolean isIntersecting_0(BitField8x8x1 that) {
	...
	protected void union_0(BitField8x8x1 that) {
		this._0 |= that._0;
	}
	...
	protected void intersect_0(BitField8x8x1 that) {
		this._0 &= that._0;
	}
	...
	protected void exclusive_0(BitField8x8x1 that) {
		this._0 ^= that._0;
	}
	...
	protected void subtract_0(BitField8x8x1 that) {
		this._0 &= ~that._0;
	}
