...
public class MutableBitField20x20x1Impl extends BitField20x20x1Impl implements MutableBitField {
	...
	public void set(BitField that0) {
		if(!(that0 instanceof BitField20x20x1Impl)) {
			MutableBitField.super.set(that0);
			return;
		}
		var that = (BitField20x20x1Impl) that0;
		this.set_0(that);
	}
	protected void set_0(BitField20x20x1Impl that) {
		this._0 = that._0;
		this._1 = that._1;
		this._2 = that._2;
		this._3 = that._3;
	...
	protected void toImmutable_0(ImmutableBitField20x20x1Impl that) {
		that._0 = this._0;
		that._1 = this._1;
		that._2 = this._2;
		that._3 = this._3;
	...
	public MutableBitField20x20x1Impl clone() {
		var result = new MutableBitField20x20x1Impl();
		result.set(this);
		return result;
	}
	...
	protected void union_0(BitField20x20x1Impl that) {
		this._0 |= that._0;
		this._1 |= that._1;
		this._2 |= that._2;
		this._3 |= that._3;
	...
	protected void intersect_0(BitField20x20x1Impl that) {
		this._0 &= that._0;
		this._1 &= that._1;
		this._2 &= that._2;
		this._3 &= that._3;
	...
	protected void exclusive_0(BitField20x20x1Impl that) {
		this._0 ^= that._0;
		this._1 ^= that._1;
		this._2 ^= that._2;
		this._3 ^= that._3;
	...
	protected void subtract_0(BitField20x20x1Impl that) {
		this._0 &= ~that._0;
		this._1 &= ~that._1;
		this._2 &= ~that._2;
		this._3 &= ~that._3;
