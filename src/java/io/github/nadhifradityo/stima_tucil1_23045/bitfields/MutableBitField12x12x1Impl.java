...
public class MutableBitField12x12x1Impl extends BitField12x12x1Impl implements MutableBitField {
	...
	protected void set_0(BitField12x12x1Impl that) {
		this._0 = that._0;
		this._1 = that._1;
		this._2 = that._2;
	}
	...
	protected void toImmutable_0(ImmutableBitField12x12x1Impl that) {
		that._0 = this._0;
		that._1 = this._1;
		that._2 = this._2;
	}
	...
	public MutableBitField12x12x1Impl clone() {
		var result = new MutableBitField12x12x1Impl();
		result.set(this);
		return result;
	}
	...
	protected void union_0(BitField12x12x1Impl that) {
		this._0 |= that._0;
		this._1 |= that._1;
		this._2 |= that._2;
	}
	...
	protected void intersect_0(BitField12x12x1Impl that) {
		this._0 &= that._0;
		this._1 &= that._1;
		this._2 &= that._2;
	}
	...
	protected void exclusive_0(BitField12x12x1Impl that) {
		this._0 ^= that._0;
		this._1 ^= that._1;
		this._2 ^= that._2;
	}
	...
	protected void subtract_0(BitField12x12x1Impl that) {
		this._0 &= ~that._0;
		this._1 &= ~that._1;
		this._2 &= ~that._2;
	}
