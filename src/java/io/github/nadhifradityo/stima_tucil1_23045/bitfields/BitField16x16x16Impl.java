...
public abstract class BitField16x16x16Impl implements BitField {
	...
	public abstract ImmutableBitField16x16x16Impl toImmutable();
	...
	protected boolean equals_0(BitField16x16x16Impl that) {
	...
	protected boolean equals_1(BitField16x16x16Impl that) {
	...
	protected boolean equals_2(BitField16x16x16Impl that) {
	...
	protected boolean equals_3(BitField16x16x16Impl that) {
	...
	protected boolean isIntersecting_0(BitField16x16x16Impl that) {
	...
	protected boolean isIntersecting_1(BitField16x16x16Impl that) {
	...
	protected boolean isIntersecting_2(BitField16x16x16Impl that) {
	...
	protected boolean isIntersecting_3(BitField16x16x16Impl that) {
