...
public abstract class BitField20x20x10Impl implements BitField {
	...
	protected boolean equals_0(BitField20x20x10Impl that) {
	...
	protected boolean equals_1(BitField20x20x10Impl that) {
	...
	protected boolean equals_2(BitField20x20x10Impl that) {
	...
	protected boolean equals_3(BitField20x20x10Impl that) {
